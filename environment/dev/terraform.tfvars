...
vms = {
  vm1 = {
    ...
    kv_name      = "edfusion-kv-00"
    username_key = "vm-username-00"
    password_key = "vm-user-password-00"
    publisher    = "Canonical"
...
mssql_server = {
  mssqlserver = {
    name                = "edfusion-mssql-server"
    resource_group_name = "apple_rg"
    location            = "westus"
    version             = "12.0"
    minimum_tls_version = "1.2"
    kv_name             = "edfusion-kv-00"
    username_sqlkey     = "sql-username-00"
    password_sqlkey     = "mssql-password-00"
  }
}
